...
public class AssignRequestWindow extends JFrame implements PeriodHolder {
    ...
    private void createButtons() {
        ...
        asignateRequestInMostSatisfactoryClassroom = new JButton("Asignar Pedido en el Aula más satisfactoria");
        ...
        asignateClassroomAssignment = new JButton("Asignar pedido en el aula y período seleccionados");
        createAsignateClassroomAssignmentListeners();

        asignateClassroomAssignmentWithDesiredPeriodAndRequiredResources =
                new JButton("Asignar pedido en el aula, período y recursos seleccionados");
...
//                            classroomRequestSelection, classroomSelection, periodSelection, resources);
    ...
    private void createClassroomsTable() {
        ...
        classroomsTable.getSelectionModel().addListSelectionListener(
                AssignRequestWindow.this::whenClassroomsTableSelectionChanged);
    ...
    private void createSelectedItemsViewPanel() {
        ...
        periodTextArea = new JTextArea("Todavía no se eligió ningún período");
