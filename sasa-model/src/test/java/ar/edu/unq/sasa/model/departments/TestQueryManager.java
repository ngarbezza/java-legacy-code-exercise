...
public class TestQueryManager {
    ...
    public void satisfactionsFromClassroomAndRequest() {
        ...
        ClassroomRequest classroomRequest = new ClassroomRequest(desHours, subject, professor, 0, new HashSet<>(), 30);
    ...
    public void classroomsThatSatisfyCapacityRequirement() {
        ...
        ClassroomRequest request = new ClassroomRequest(null, null, null, 0L, new HashSet<>(), 15);
